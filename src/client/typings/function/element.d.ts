 ...
 * @tupleReturn
 **/
declare function getElementPosition(theElement: Element): [number, number, number] | [false, null, null];
 ...
 * @tupleReturn
 **/
declare function getElementRotation(theElement: Element, rotOrder?: string): [number, number, number] | [false, null, null];
