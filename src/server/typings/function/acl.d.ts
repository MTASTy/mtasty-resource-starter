...
declare namespace Server {
   ...
   **/
  function aclCreate(aclName: string): Acl;
   ...
   **/
  function aclCreateGroup(groupName: string): AclGroup | false;
   ...
   **/
  function aclDestroy(theACL: Acl): boolean;
   ...
   **/
  function aclDestroyGroup(aclGroup: AclGroup): boolean;
   ...
   **/
  function aclGet(aclName: string): Acl | false | undefined;
   ...
   **/
  function aclGetGroup(groupName: string): AclGroup | false | undefined;
   ...
   **/
  function aclGetName(theAcl: Acl): string | false | undefined;
   ...
   **/
  function aclGetRight(theAcl: Acl, rightName: string): boolean | undefined;
   ...
   **/
  function aclGroupAddACL(theGroup: AclGroup, theACL: Acl): boolean | undefined;
   ...
   **/
  function aclGroupAddObject(theGroup: AclGroup, theObjectName: string): boolean;
   ...
   **/
  function aclGroupGetName(aclGroup: AclGroup): string | false | undefined;
   ...
   **/
  function aclGroupList(): object | false | undefined;
   ...
   **/
  function aclGroupListACL(theGroup: AclGroup): object | false | undefined;
   ...
   **/
  function aclGroupListObjects(theGroup: AclGroup): object | false | undefined;
   ...
   **/
  function aclGroupRemoveACL(theGroup: AclGroup, theACL: Acl): boolean | undefined;
   ...
   **/
  function aclGroupRemoveObject(theGroup: AclGroup, theObjectString: string): boolean | undefined;
   ...
   **/
  function aclList(): object | false | undefined;
   ...
   **/
  function aclListRights(theACL: Acl, allowedType: string): object | false | undefined;
   ...
   **/
  function aclRemoveRight(theAcl: Acl, rightName: string): boolean | undefined;
   ...
   **/
  function aclSave(): boolean | undefined;
   ...
   **/
  function aclSetRight(theAcl: Acl, rightName: string, hasAccess: boolean): boolean | undefined;
   ...
   **/
  function hasObjectPermissionTo(element: string | Element, theAction: string, defaultPermission?: boolean): boolean | undefined;
   ...
   **/
  function isObjectInACLGroup(theObject: string, theGroup: AclGroup): boolean | undefined;
