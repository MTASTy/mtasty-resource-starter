...
declare namespace Server {
   ...
   **/
  function addEventHandler(eventName: string, attachedTo: Element, handlerFunction: EventHandler, getPropagated?: boolean, priority?: "high" | "normal" | "low"): boolean;
   ...
   **/
  function cancelEvent(cancel?: boolean, reason?: string): true;
   ...
   **/
  function cancelLatentEvent(thePlayer: Player, handle: number): boolean;
   ...
   **/
  function getEventHandlers(eventName: string, attachedTo: Element): EventHandler[];
   ...
   **/
  function getLatentEventHandles(thePlayer: Player): EventHandler[] | false;
   ...
   **/
  function getLatentEventStatus(thePlayer: Player, handle: number): LatentEventStatus | false;
   ...
   **/
  function removeEventHandler(eventName: string, attachedTo: Element, functionVar: EventHandler): boolean;
   ...
   **/
  function triggerEvent(eventName: string, baseElement: Element, ...args: any[]): undefined | boolean;
   ...
   **/
  function triggerClientEvent(sendTo: Element, name: string, sourceElement: Element, ...args: any[]): boolean;
   ...
   * @see https://wiki.mtasa.com/wiki/TriggerClientEvent
   **/
  function triggerClientEvent(name: string, sourceElement: Element, ...args: any[]): boolean;
   ...
   **/
  function triggerLatentClientEvent(sendTo: Element | Element[], name: string, bandwidth: number, persist: boolean, theElement: Element, ...args: any[]): boolean;
   ...
   * @see https://wiki.mtasa.com/wiki/TriggerLatentClientEvent
   **/
  function triggerLatentClientEvent(sendTo: Element | Element[], name: string, bandwidth: number, theElement: Element, ...args: any[]): boolean;
   ...
   * @see https://wiki.mtasa.com/wiki/TriggerLatentClientEvent
   **/
  function triggerLatentClientEvent(sendTo: Element | Element[], name: string, persist: boolean, theElement: Element, ...args: any[]): boolean;
   ...
   * @see https://wiki.mtasa.com/wiki/TriggerLatentClientEvent
   **/
  function triggerLatentClientEvent(sendTo: Element | Element[], name: string, theElement: Element, ...args: any[]): boolean;
   ...
   * @see https://wiki.mtasa.com/wiki/TriggerLatentClientEvent
   **/
  function triggerLatentClientEvent(name: string, bandwidth: number, persist: boolean, theElement: Element, ...args: any[]): boolean;
   ...
   * @see https://wiki.mtasa.com/wiki/TriggerLatentClientEvent
   **/
  function triggerLatentClientEvent(name: string, bandwidth: number, theElement: Element, ...args: any[]): boolean;
   ...
   * @see https://wiki.mtasa.com/wiki/TriggerLatentClientEvent
   **/
  function triggerLatentClientEvent(name: string, persist: boolean, theElement: Element, ...args: any[]): boolean;
   ...
   * @see https://wiki.mtasa.com/wiki/TriggerLatentClientEvent
   **/
  function triggerLatentClientEvent(name: string, theElement: Element, ...args: any[]): boolean;
