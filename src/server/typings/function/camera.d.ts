...
declare namespace Server {
   ...
   **/
  function fadeCamera(thePlayer: Player, fadeIn: boolean, timeToFade?: number, red?: number, green?: number, blue?: number): boolean;
   ...
   **/
  function getCameraInterior(thePlayer: Player): number | false;
   ...
   **/
  function getCameraMatrix(thePlayer: Player): [number, number, number, number, number, number, number, number] | false;
   ...
   **/
  function getCameraTarget(thePlayer: Player): Element | false;
   ...
   **/
  function setCameraInterior(thePlayer: Player, interior: number): boolean;
   ...
   **/
  function setCameraMatrix(thePlayer: Player, positionX: number, positionY: number, positionZ: number, lookAtX?: number, lookAtY?: number, lookAtZ?: number, roll?: number, fov?: number): boolean;
   ...
   **/
  function setCameraTarget(thePlayer: Player, target: Player): boolean;
