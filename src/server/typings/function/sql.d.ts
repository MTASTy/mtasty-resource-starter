...
declare namespace Server {
   ...
   **/
  function executeSQLQuery(query: string, ...params: string[] | number[]): object | false;
   ...
   **/
  function dbConnect(databaseType: "sqlite" | "mysql", host: string, username?: string, password?: string, options?: string): Connection | false;
   ...
   **/
  function dbExec(databaseConnection: Connection, query: string, ...params: string[] | number[]): boolean;
   ...
   **/
  function dbFree(queryHandle: QueryHandle): boolean;
   ...
   **/
  function dbPoll(queryHandle: QueryHandle, timeout: number, multipleResults?: boolean): object | undefined | false;
   ...
   **/
  function dbPrepareString(databaseConnection: Connection, query: string, ...params: string[] | number[]): string | false;
   ...
   **/
  function dbQuery(callbackFunction: SimpleHandler, callbackArguments: any[], databaseConnection: Connection, query: string, ...params: string[] | number[]): QueryHandle | false;
   ...
   * @see https://wiki.mtasa.com/wiki/DbQuery
   **/
  function dbQuery(callbackFunction: SimpleHandler, databaseConnection: Connection, query: string, ...params: string[] | number[]): QueryHandle | false;
