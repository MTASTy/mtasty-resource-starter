...
declare namespace Server {
  ...
  type CommandHandler = (thePlayer: Player, commandName: string, ...args: any[]) => void;
   ...
   **/
  function addCommandHandler(commandName: string, handlerFunction: CommandHandler, restricted?: boolean, caseSensitive?: boolean): boolean;

  type BindHandler = (thePlayer: Player, key: string, keyState: string, ...args: any[]) => void;
   ...
   **/
  function bindKey(thePlayer: Player, key: string, keyState: "up" | "down" | "both", handlerFunction: BindHandler, ...args: any[]): boolean;
   ...
   * @see https://wiki.mtasa.com/wiki/BindKey
   **/
  function bindKey(thePlayer: Player, key: string, keyState: "up" | "down" | "both", commandName: string, ...args: any[]): boolean;
   ...
   **/
  function executeCommandHandler(commandName: string, thePlayer: Player, ...args: any[]): boolean;
   ...
   **/
  function getCommandHandlers(theResource: Resource): object;
   ...
   **/
  function getControlState(thePlayer: Player, controlName: string): boolean;
   ...
   **/
  function getFunctionsBoundToKey(thePlayer: Player, key: string, keyState: "up" | "down" | "both"): object;
   ...
   **/
  function getKeyBoundToFunction(thePlayer: Player, theFunction: SimpleHandler): string;
   ...
   **/
  function isControlEnabled(thePlayer: Player, control: string): boolean;
   ...
   **/
  function isKeyBound(thePlayer: Player, key: string, keyState?: "up" | "down", handler?: SimpleHandler): boolean;
   ...
   **/
  function removeCommandHandler(commandName: string, handler?: SimpleHandler): boolean;
   ...
   **/
  function setControlState(thePlayer: Player, control: string, state: boolean): boolean;
   ...
   **/
  function toggleAllControls(thePlayer: Player, enabled: boolean, gtaControls?: boolean, mtaControls?: boolean): boolean;
   ...
   **/
  function toggleControl(thePlayer: Player, control: string, enabled: boolean): boolean;
   ...
   **/
  function unbindKey(thePlayer: Player, key: string, keyState?: "up" | "down" | "both", handler?: BindHandler): boolean;
   ...
   * @see https://wiki.mtasa.com/wiki/UnbindKey
   **/
  function unbindKey(thePlayer: Player, key: string, keyState: "up" | "down" | "both", commandName: string): boolean;
