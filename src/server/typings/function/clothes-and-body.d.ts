...
declare namespace Server {
   ...
   **/
  function getBodyPartName(bodyPartID: number): string | false;
   ...
   **/
  function getClothesByTypeIndex(clothesType: number, clothesIndex: number): [string, string] | false;
   ...
   **/
  function getClothesTypeName(clothesType: number): string | false;
   ...
   **/
  function getTypeIndexFromClothes(clothesTexture: string, clothesModel: string): [number, number] | false;
