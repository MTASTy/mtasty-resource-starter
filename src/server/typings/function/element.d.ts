...
declare namespace Server {
   ...
   **/
  function cloneElement(theElement: Element, xPos?: number, yPos?: number, zPos?: number, cloneChildren?: boolean): Element | false;
   ...
   **/
  function getElementByIndex(theType: string, index: number): Element | false;
   ...
   **/
  function getElementZoneName(theElement: Element, citiesonly?: boolean): string;
   ...
   **/
  function getLowLODElement(theElement: Element): Element | false;
   ...
   **/
  function setElementAngularVelocity(theElement: Element, rx: number, ry: number, rz: number): boolean;
   ...
   **/
  function setElementData(theElement: Element, key: string, value: any, synchronize?: boolean): boolean;
   ...
   **/
  function setElementPosition(theElement: Element, x: number, y: number, z: number, warp?: boolean): boolean;
   ...
   **/
  function setElementRotation(theElement: Element, rotX: number, rotY: number, rotZ: number, rotOrder?: "default" | "ZXY" | "ZYX", conformPedRotation?: boolean): boolean;
