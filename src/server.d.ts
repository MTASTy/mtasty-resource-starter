 ...
 * @param [cancel=true] unknown
 * @param [reason=] unknown
 * @returns Always returns true.
 * @see https://wiki.mtasa.com/wiki/CancelEvent
**/
declare function cancelEvent(cancel?: boolean, reason?: string): boolean;
...
**/
declare function fadeCamera(thePlayer: Player, fadeIn: boolean, timeToFade?: number, ,: unknown, red?: number, green?: number, blue?: number): boolean;
 ...
 * @param to unknown
 * @param the unknown
 * @param interior unknown
 * @param player unknown
 * @param = unknown
 * @param someValue unknown
 * @param set unknown
...
**/
declare function getCameraInterior(player: number, or: unknown, player: number, to: unknown, the: unknown, interior: Camera, player: unknown, =: unknown, someValue: number, set: unknown, camera: unknown, value: unknown): [number, Player, , , number, Player, , , , , Camera, , , Player, , , number, , , , , Camera];
...
**/
declare function getCameraMatrix(thePlayer: Player): [number, number, number, number, number, number, number, number];
...
**/
declare function getLatentEventStatus(thePlayer: Player, handle: number): object;
...
**/
declare function aclCreate(aclName: string): unknown;
...
**/
declare function aclCreateGroup(groupName: string): unknown;
...
**/
declare function aclDestroy(theACL: unknown): boolean;
...
**/
declare function aclDestroyGroup(aclGroup: unknown): boolean;
...
**/
declare function aclGet(aclName: string): unknown;
...
**/
declare function aclGetGroup(groupName: string): unknown;

/**
 * Get the name of given ACL.
 * @param theAcl unknown
...
**/
declare function aclGetName(theAcl: unknown): string;
...
**/
declare function aclGetRight(theAcl: unknown, rightName: string): boolean;
...
**/
declare function aclGroupAddACL(theGroup: unknown, theACL: unknown): boolean;

/**
 * This function adds an object to the given ACL group.
 * An object can be a player's account, specified as:
 * ''user.
 * ''
...
**/
declare function aclGroupAddObject(theGroup: unknown, theObjectName: string): boolean;
...
**/
declare function aclGroupGetName(aclGroup: unknown): string;
...
**/
declare function aclGroupList(): object;
...
**/
declare function aclGroupListACL(theGroup: unknown): object;
...
**/
declare function aclGroupListObjects(theGroup: unknown): object;
...
**/
declare function aclGroupRemoveACL(theGroup: unknown, theACL: unknown): boolean;
...
**/
declare function aclGroupRemoveObject(theGroup: unknown, theObjectString: string): boolean;
...
**/
declare function aclList(): object;
...
**/
declare function aclListRights(theACL: unknown, allowedType: string): object;
 ...
 * @returns Returns true if the XML was successfully reloaded from the file, false or nil if the XML was invalid, didn't exist or could not be loaded for some other reason.
 ...
 * @returns Returns true if the given right was successfully removed from the given ACL, false or nil if it could not be removed for some reason, ie. it didn't exist in the ACL.
 * @see https://wiki.mtasa.com/wiki/AclRemoveRight
**/
declare function aclRemoveRight(theAcl: unknown, rightName: string): boolean;
...
**/
declare function aclSave(): boolean;
...
**/
declare function aclSetRight(theAcl: unknown, rightName: string, hasAccess: boolean): boolean;
...
**/
declare function addAccount(name: string, pass: string, allowCaseVariations?: boolean): unknown;
...
**/
declare function copyAccountData(theAccount: unknown, fromAccount: unknown): boolean;
 ...
 * @param [caseSensitive=true] unknown
...
**/
declare function getAccount(username: string, password: string, caseSensitive?: boolean): unknown;
...
**/
declare function getAccountByID(id: number): unknown;
...
**/
declare function getAccountData(theAccount: unknown, key: string): string;
...
**/
declare function getAccountID(theAccount: unknown): number;
...
**/
declare function getAccountIP(theAccount: unknown): string;
...
**/
declare function getAccountName(theAccount: unknown): string;
...
**/
declare function getAccountPlayer(theAccount: unknown): Player;

/**
 * New items: 3.0140,1.4,This function returns the last serial that logged onto the specified account.
...
**/
declare function getAccountSerial(theAccount: unknown): string;
...
**/
declare function getAccountsByData(dataName: string, value: string): object;
...
**/
declare function getAccountsByIP(ip: string): object;

/**
 * New items: 3.014,1.4,This function returns a table containing all accounts that were logged onto from specified serial. If the serial is empty string, it will return all accounts that were never logged onto.
...
**/
declare function getAccountsBySerial(serial: string): object;
...
**/
declare function getAllAccountData(theAccount: unknown): object;
...
**/
declare function getPlayerAccount(thePlayer: Player): unknown;
 ...
 * Then, all you need to do is add one 'if' statement to your code:
...
**/
declare function hasObjectPermissionTo(element: string, ,: unknown, theAction: string, defaultPermission?: boolean): boolean;
...
**/
declare function isGuestAccount(theAccount: unknown): boolean;
 ...
 * @param theObject the name of the object to check. Examples
...
**/
declare function isObjectInACLGroup(theObject: string, theGroup: unknown): boolean;
...
**/
declare function logIn(thePlayer: Player, theAccount: unknown, thePassword: string): boolean;
...
**/
declare function logOut(thePlayer: Player): boolean;
...
**/
declare function removeAccount(theAccount: unknown): boolean;
...
**/
declare function setAccountData(theAccount: unknown, key: string, value: string): boolean;
...
**/
declare function setAccountName(theAccount: unknown, name: string, allowCaseVariations?: boolean): boolean;
...
**/
declare function setAccountPassword(theAccount: unknown, password: string): boolean;
 ...
 * @param [sendTo=getRootElement()] The event will be sent to all players that are children of the specified element. By default this is the root element, and hence the event is sent to all players. If you specify a single player it will just be sent to that player. This argument can also be a table of player elements.
 * @param name The name of the event to trigger client side. You should register this event with addEvent and add at least one event handler using addEventHandler.
 * @param [bandwidth=50000] The bytes per second rate to send the data contained in the arguments.
...
**/
declare function triggerLatentClientEvent(sendTo?: unknown, name: string, bandwidth?: number, persist?: boolean, theElement: Element, arguments: ...any[]): boolean;
