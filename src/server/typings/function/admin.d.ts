...
declare namespace Server {
   ...
   **/
  function addBan(IP: string | undefined, Username: string | undefined, Serial: string | undefined, player?: Player, reason?: string, seconds?: number): Ban | false;
   ...
   **/
  function banPlayer(bannedPlayer: Player, IP?: boolean, Username?: boolean, Serial?: boolean, reason?: string, seconds?: number): Ban | false;
   ...
   **/
  function getBanAdmin(theBan: Ban): string | false;
   ...
   **/
  function getBanIP(theBan: Ban): string | false;
   ...
   **/
  function getBanNick(theBan: Ban): string | false;
   ...
   **/
  function getBanReason(theBan: Ban): string | false;
   ...
   **/
  function getBanSerial(theBan: Ban): string | false;
   ...
   **/
  function getBanTime(theBan: Ban): number | false;
   ...
   **/
  function getBanUsername(theBan: Ban): string | false;
   ...
   **/
  function getBans(getBans: object): [];
   ...
   **/
  function getUnbanTime(theBan: Ban): number | false;
   ...
   **/
  function isBan(theBan: Ban): boolean;
   ...
   **/
  function kickPlayer(kickedPlayer: Player, responsiblePlayer?: string | Player, reason?: string): boolean;
   ...
   **/
  function setBanAdmin(theBan: Ban, theAdmin: string): boolean;
   ...
   **/
  function setBanNick(theBan: Ban, theNick: string): boolean;
   ...
   **/
  function setBanReason(theBan: Ban, theReason: string): boolean;
   ...
   **/
  function setUnbanTime(theBan: Ban, theTime: number): boolean;
   ...
   **/
  function removeBan(theBan: Ban, player?: Player): boolean;
