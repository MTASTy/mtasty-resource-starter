...
declare namespace Server {
   ...
   **/
  function addAccount(name: string, pass: string, allowCaseVariations?: boolean): Account | false;
   ...
   **/
  function copyAccountData(theAccount: Account, fromAccount: Account): boolean;
   ...
   **/
  function getAccount(username: string, password: string, caseSensitive?: boolean): Account | false;
   ...
   **/
  function getAccountName(theAccount: Account): string | false;
   ...
   **/
  function getAccountPlayer(theAccount: Account): Player | false;
   ...
   **/
  function isGuestAccount(theAccount: Account): boolean;
   ...
   **/
  function removeAccount(theAccount: Account): boolean;
   ...
   **/
  function setAccountData(theAccount: Account, key: string, value: string | number | boolean): boolean;
   ...
   **/
  function setAccountPassword(theAccount: Account, password: string): boolean;
   ...
   **/
  function getAccountByID(id: number): Account | false;
   ...
   **/
  function getAccountID(theAccount: Account): number | false;
   ...
   **/
  function getAccountsByIP(ip: string): object | false;
   ...
   **/
  function setAccountName(theAccount: Account, name: string, allowCaseVariations?: boolean): boolean;
