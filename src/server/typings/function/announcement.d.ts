...
declare namespace Server {
   ...
   **/
  function getGameType(): string | undefined;
   ...
   **/
  function getRuleValue(key: string): string | false;
   ...
   **/
  function removeRuleValue(key: string): boolean;
   ...
   **/
  function setGameType(gameType: string): boolean;
   ...
   **/
  function setMapName(mapName: string): boolean;
   ...
   **/
  function setRuleValue(key: string, value: string): boolean;
