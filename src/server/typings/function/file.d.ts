...
declare namespace Server {
   ...
   **/
  function fileClose(theFile: File): boolean;
   ...
   **/
  function fileCopy(filePath: string, copyToFilePath: string, overwrite?: boolean): boolean;
   ...
   **/
  function fileCreate(filePath: string): File | false;
   ...
   **/
  function fileDelete(filePath: string): boolean;
   ...
   **/
  function fileFlush(theFile: File): boolean;
   ...
   **/
  function fileGetPath(theFile: File): string;
   ...
   **/
  function fileGetPos(theFile: File): number | false;
   ...
   **/
  function fileGetSize(theFile: File): number | false;
   ...
   **/
  function fileIsEOF(theFile: File): boolean;
   ...
   **/
  function fileOpen(filePath: string, readOnly?: boolean): File | false;
   ...
   **/
  function fileRead(theFile: File, count: number): string;
   ...
   **/
  function fileRename(filePath: string, newFilePath: string): boolean;
   ...
   **/
  function fileSetPos(theFile: File, offset: number): number | false;
   ...
   **/
  function fileWrite(theFile: File, string: string, ...additionalStrings: string[]): number | false;
